        ...
        while(salir == true){
            ...
            switch (op){
                case 1:
                    ...
                    Ahorro1 ahorro = new Ahorro1(nomCliente, numCliente, numCuenta, capInvert, plazInver, inteAnual);

                    //Método de la clase padre
                    ahorro.calcularInteresGan();

                    // Concatenación de cadenas
                    cadena2 += "\t"+ahorro.getNumCliente()+"\t\t\t"+ahorro.getNomCliente()+"\t\t\t\t"
                            +ahorro.getNumCuenta()+"\t\t\t\t\t"+ahorro.getInteresGan()+"\n";
                    break;
                ...
                case 2:
                    ...
                    // Creación de un nuevo objeto
                    Pagare1 pagare = new Pagare1(nomCliente, numCliente, numCuenta, capInvert, plazInver, inteAnual);

                    //Método de la clase padre
                    pagare.calcularInteresGan();

                    // Concatenación de cadenas
                    cadena2 += "\t"+pagare.getNumCliente()+"\t\t\t"+pagare.getNomCliente()
                            +"\t\t\t\t"+pagare.getNumCuenta()+"\t\t\t\t"+pagare.getInteresGan()+"\n";
                    break;
                ...
                case 3:
                    ...
                    // Creación de un nuevo objeto
                    Maestra1 maestra = new Maestra1(nomCliente, numCliente, numCuenta, capInvert, plazInver, inteAnual);

                    // Método de la clase padre
                    maestra.calcularInteresGan();
                    // Concatenación de cadenas
                    cadena2 += "\t"+maestra.getNumCliente()+"\t\t\t"+maestra.getNomCliente()
                            +"\t\t\t\t"+maestra.getNumCuenta()+"\t\t\t\t\t"+maestra.getInteresGan()+"\n";
                    break;
